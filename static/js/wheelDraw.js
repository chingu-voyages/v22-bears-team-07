...
function draw_sliceCoords(arr){
  ...
  */
  ...
  if (type !== 'number'){
    ...
    console.log("ERROR in draw_sliceCoords(arr), given arr does not contain nesting at 0.")
    }
}
...
function listen_chart() {
    ...
    checkbtn.addEventListener('click', RunCircle)
}
